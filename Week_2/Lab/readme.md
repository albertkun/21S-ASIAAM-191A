...
- Extra Credit: (any of these) 
   - Add another `geojson` (it can be `lab1.geojson`) to a completely different HTML page not `index.html`. (Be sure to link it to your `index.html` and describe what you are showing)
